...
px import ./my_photos --dry-run

# 自动删除重复的源文件 (默认是移入 duplicates 目录)
px import ./my_photos --delete-source

# 跳过确认直接执行
px import ./my_photos --yes
```
...
# 整理特定月份的所有文件 (同时检查 archive 和 snapshot)
px sync -m 202405
